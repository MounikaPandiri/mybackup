...
class VNFParser(object):
    def __init__(self, vnf_context, vnfd=None, flavour=None, vdu_list=None, vnfd_name=None, nsd=None):
    ...
    def diagnostics_params(self, data, vdu):
            self.new_vnfd['vdus'][vdu]['postconfigure']['diagnostics_params'] = data
