...
class NetconfJavaWrapper:
	...
	def executeCommand(self, command):
		commandList = [command]
		print commandList
		executionList = ['/home/openstack3/Desktop/workspace/OpenYuma-master/netconf/target/bin/yangcli']
...
wrapper = NetconfJavaWrapper("localhost","openstack3","openstack", "830")
cmd1 = build_cmds()
cmd_args = sys.argv[1]
