    ...
    def parse(self,cfg):
        for i in range(0, len(cfg['Ims'])):
            if(cfg['Ims'][i]['name']=="vBono"):
                ...
                self.localip=cfg['Ims'][i]['vm_details']['network_interfaces']['pkt-in']['ips']['ims-vbono']
                self.publicip=cfg['Ims'][i]['vm_details']['network_interfaces']['pkt-in']['ips']['ims-vbono']
                self.mgmtip=cfg['Ims'][i]['vm_details']['network_interfaces']['management-interface']['ips']['ims-vbono']
         
                     
            if(cfg['Ims'][i]['name']=="vSprout"):
                self.sproutip=cfg['Ims'][i]['vm_details']['network_interfaces']['pkt-in']['ips']['ims-vsprout']
